...
/**
  * @brief  USBD_HID_GetState
  *         Get HID State
  * @param  pdev: device instance
  * @retval usb state  (HID_IDLE, HID_BUSY)
  */
uint8_t USBD_HID_GetState(USBD_HandleTypeDef  *pdev)
{
  return ((USBD_HID_HandleTypeDef *)pdev->pClassData)->state;
}
