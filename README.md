...
```C
  ...
  0x09, 0x??, // 0x30 - USAGE (X), 0x31 - USAGE (Y), 0x32 - USAGE (Z), 0x33 - USAGE (Rx), 0x34 - USAGE (Ry), 0x35 - USAGE (Rz), 0x40 - USAGE (Vx), 0x41 - USAGE (Vy), 0x42 - USAGE (Vz), 0x43 - USAGE (Vbrx), 0x44 - USAGE (Vbry), 0x45 - USAGE (Vbrz), 0x45 - USAGE (Vno)
...
//  0x75, 0x10, // REPORT_SIZE (16)
  0x95, 0x??, // REPORT_COUNT (x) (axis count)
...
//  0x75, 0x10, // REPORT_SIZE (16)
  ...
  0x29, 0x??, // USAGE_MAXIMUM (Button x) (buttons count)
  0x15, 0x00, // LOGICAL_MINIMUM (0)
  0x25, 0x01, // LOGICAL_MAXIMUM (1)
  0x75, 0x01, // REPORT_SIZE (1)
  0x95, 0x??, // REPORT_COUNT (x) (buttons count)
  0x81, 0x02, // INPUT (Data,Var,Abs)
  0x95, 0x??, // REPORT_COUNT (n) (remaining bits alignment: the number of bytes to accommodate the number of buttons multiplied by 8, minus the number of buttons)
